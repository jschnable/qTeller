...
if (isset($_POST["gene"])) {
$mycommand = "python3 interval_handling/make_spreadsheet_named_gene_singlegenome.py --names $mynames";
}else if(isset($_POST["protein"])){
$mycommand = "python3 interval_handling/make_spreadsheet_named_Pro.py --names $mynames";
}
