...
<h2><font color="green">Multi-Genome Expression for Genes in an Interval</font></h2>
...
<p>To find the FPKM expression values of genes within a genomic interval, select a genome, select a chromosome, then enter the genome start and stop positions of your interval.</p>
...
<form action="results_multigenome.php" method="post">
<b><font color="green">Genome Version: <select name='filtered'>
<option value="genomeselect">select genome</option>
<option value="B73">B73_refgen5</option>
<option value="Ki11">Ki11</option>
...
?>
<br>
<input type="submit" style="font-face: 'Comic Sans MS'; font-size: larger; color: white; background-color: #cc0000; border: 3pt ridge lightgrey" value=" Submit! "><br>
</div>
</body>
</html>
