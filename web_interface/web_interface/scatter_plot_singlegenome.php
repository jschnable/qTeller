...
echo "See the expression or abundance of <a href=\"bar_chart_singlegenome.php?name=$mygene1&info=$all_info\">$mygene1</a> or <a href=\"bar_chart_singlegenome.php?name=$mygene2&info=$all_info\">$mygene2</a> as a bar chart<br>";
echo "<a href=\"scatter_plot_singlegenome.php?name1=$mygene1&name2=$mygene2&xmax=$xmax&ymax=$ymax&info=$all_info\">Regenerate this particular analysis</a> <-- copy this link to share this analysis.<br>";
