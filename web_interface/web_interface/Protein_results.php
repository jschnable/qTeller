...
if (isset($_POST["gene"])) {
$mycommand = "python3 interval_handling/make_spreadsheet_gene_singlegenome.py --chr $mychr --start $mystart --stop $mystop";
} else if(isset($_POST["protein"])){
$mycommand = "python3 interval_handling/make_spreadsheet_Pro.py --chr $mychr --start $mystart --stop $mystop";
