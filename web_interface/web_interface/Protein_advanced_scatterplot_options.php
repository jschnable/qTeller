...
<h2><font color="green">Two-Gene Scatterplot Expression or Abundance Advanced Options</font></h2>
<form action="Rna_Protein_scatter_plot.php" method="post">
<b><font color="green">Gene1 Name: <input id = 'geneName1' type="text" name='name1' <?php if ($have_data) {echo "value=\"$mygene1\"";} ?> /><br>
Gene2 Name: <input id = 'geneName2' type="text" name='name2' <?php if ($have_data) {echo "value=\"$mygene2\"";} ?> /></font></b><br>
...
<p><h3><font color="white">Select expression or abundance data</font></h3></p>
        ...
        <p><b>Select which expression or abundance datasets you would like to analyze:</b><br>
...
<input type="submit" style="font-face: 'Comic Sans MS'; font-size: larger; color: white; background-color: #cc0000; border: 3pt ridge lightgrey" value=" Submit for Protein Abundance! " name = "protein"><br><br>
</div>
</body>
</html>
