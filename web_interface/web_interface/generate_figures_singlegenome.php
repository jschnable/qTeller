...
<h2><font color="green">Single-Genome Visualize Expression</font></h2>
<p>View all dataset FPKM expression graphs for a query gene, or compare expression graphs between two genes. (To select only specific datasets, go to Advanced Options below.)</p>
...
<p>To select only specific datasets, go to <a href="advanced_barchart_options_singlegenome.php">Advanced options</a></p>
...
<form action="scatter_plot_singlegenome.php" method="post">
...
<br>
<p>To select only specific datasets, go to <a href="advanced_scatterplot_options_singlegenome.php">Advanced options</a></p>
<input type="submit" style="font-face: 'Comic Sans MS'; font-size: larger; color: white; background-color: #cc0000; border: 3pt ridge lightgrey" value=" Submit! " name = "gene">
<br>
<br>
</div>
