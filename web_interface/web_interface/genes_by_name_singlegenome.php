...
<h2><font color="green">Single-Genome Expression for Genes by Name</font></h2>
<p>Retrieve FPKM expression data for a user-provided list of genes.</p>
<div id="subheaderContainer">
<p><h3><font color="white">Paste gene IDs</font></h3></p>
        </div>
<form action="named_results_singlegenome.php" method="post">
<p><b><font color="green">Paste gene IDs in the box below. One gene per row.</font></b> <i>Try entering the ID for <i id='gene4' onclick="copyToClipboard('gene4','geneName')" style="cursor: pointer;color:blue;">enter_test_gene_here</i></i></p>
