...
for row in c:
    ...
    p_dict[myname].append("<a href='http://yourwebsite/bar_chart_singlegenome.php?name=%s&info=%s'>http://yourwebsite/bar_chart_singlegenome.php?name=%s&info=%s</a>" % (myname,all_info,myname,all_info))
